...
function buildLengthHint(userText) {
  ...
  return [
    ...
    "",
    "- **기본 분량: 2~3줄.** 항상 이 선에서 시작한다.",
    "- 질문이 복잡하거나 설명이 필요한 사안이면 4~8줄까지 늘려 구조화.",
    "- 가벼운 인사·농담·잡담처럼 맥락이 정말 간단할 때만 1~2줄로 줄일 수 있다. 단, 이모지 단독이나 단어 하나 단답은 피할 것.",
    "- 과장된 장식이나 불필요한 반복으로 분량을 채우지 말 것.",
  ].join("\n");
}
